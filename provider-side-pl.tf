...
resource "aws_lb" "pl-lb" {
  ...
  # wmio does not offer gateway lbs, therefore this is always "network"
  load_balancer_type         = "network"
  
  # design option. By default, in production this should be set to true. Ephemeral environments mai put on false
  ...
  subnets = data.aws_vpc.reference_vpc.subnets
